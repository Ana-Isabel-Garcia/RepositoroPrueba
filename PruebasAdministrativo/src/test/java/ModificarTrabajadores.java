...
public class ModificarTrabajadores {
	...
	public void test() throws IOException {
		...
		for (int i = 1; i <= read.getFilas(ruta, "Hoja1"); i++) {
			...
			System.out.println("paterno: " + datos[1]);
			driver.findElement(cajaMaterno).sendKeys(datos[2]);
			System.out.println("materno: " + datos[2]);
			driver.findElement(cajaCorreo).sendKeys(datos[3]);
			System.out.println("correo: " + datos[3]);
			driver.findElement(cajaTelefono).sendKeys(datos[4]);
